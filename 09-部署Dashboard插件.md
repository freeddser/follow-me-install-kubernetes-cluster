...
浏览器访问 URL：`http://192.168.1.13:8086/ui`
自动跳转到：`http://192.168.1.13:8086/api/v1/proxy/namespaces/kube-system/services/kubernetes-dashboard/#/workload?namespace=default`
...
浏览器访问 URL：`http://192.168.1.13:8080/api/v1/proxy/namespaces/kube-system/services/kubernetes-dashboard`
