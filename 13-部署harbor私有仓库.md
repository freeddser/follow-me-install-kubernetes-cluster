...
``` bash
$ export NODE_IP=192.168.1.13 # 当前部署 harbor 的节点 IP
$
```
...
Now you should be able to visit the admin portal at https://192.168.1.13.
For more details, please visit https://github.com/vmware/harbor .
```

## 访问管理界面

浏览器访问 `https://${NODE_IP}`，示例的是 `https://192.168.1.13`
...
将签署 harbor 证书的 CA 证书拷贝到 `/etc/docker/certs.d/192.168.1.13` 目录下

``` bash
$ sudo mkdir -p /etc/docker/certs.d/192.168.1.13
$ sudo cp /etc/kubernetes/ssl/ca.pem /etc/docker/certs.d/192.168.1.13/ca.crt
$
```
