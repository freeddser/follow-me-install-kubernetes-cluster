...
$ export MASTER_IP=192.168.1.13
$ export KUBE_APISERVER="https://${MASTER_IP}:6443"
$ # 当前部署的节点 IP
$ export NODE_IP=192.168.1.13
...
$ kubectl get nodes
NAME        STATUS    AGE       VERSION
192.168.1.13   Ready     8d        v1.6.2
192.168.1.14   Ready     8d        v1.6.2
```
...
nginx-ds-6ktz8              1/1       Running            0          5m        172.30.25.19   192.168.1.13
nginx-ds-6ktz9              1/1       Running            0          5m        172.30.20.20   192.168.1.14
```
...
``` bash
$ export NODE_IP=192.168.1.13 # 当前 Node 的 IP
