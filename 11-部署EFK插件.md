...
192.168.1.13   Ready     1d        v1.6.2

$ kubectl label nodes 192.168.1.13 beta.kubernetes.io/fluentd-ds-ready=true
node "192.168.1.13" labeled
```
...
1. 通过 kube-apiserver 访问：
    ...
    Elasticsearch is running at https://192.168.1.13:6443/api/v1/proxy/namespaces/kube-system/services/elasticsearch-logging
    Heapster is running at https://192.168.1.13:6443/api/v1/proxy/namespaces/kube-system/services/heapster
    Kibana is running at https://192.168.1.13:6443/api/v1/proxy/namespaces/kube-system/services/kibana-logging
    ...
    浏览器访问 URL： `http://192.168.1.13:8080/api/v1/proxy/namespaces/kube-system/services/kibana-logging`
...
1. 通过 kubectl proxy 访问：
    ...
    浏览器访问 URL：`http://192.168.1.13:8086/api/v1/proxy/namespaces/kube-system/services/kibana-logging`
